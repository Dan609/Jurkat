...
file.copy(from=plots.png.paths, to="D:/r/png")

plots.png.detials <- file.info(plots.png.paths)
plots.png.detials <- plots.png.detials[order(plots.png.detials$mtime),]

sorted.png.names <- gsub(plots.dir.path, "D:/r/png", row.names(plots.png.detials), fixed=TRUE)
numbered.png.names <- paste0("D:/r/png", 1:length(sorted.png.names), ".png")
...
shapiro.test(data[data$probe=='8',]$mean_speed)
shapiro.test(data[data$probe=='4',]$mean_speed) # data is not normally distributed
shapiro.test(data[data$probe=='2',]$mean_speed)
shapiro.test(data[data$probe=='6',]$mean_speed)
shapiro.test(data[data$probe=='3',]$mean_speed) # data is not normally distributed
shapiro.test(data[data$probe=='7',]$mean_speed) # data is not normally distributed


shapiro.test(data[data$probe=='8',]$max_speed) # data is not normally distributed
shapiro.test(data[data$probe=='4',]$max_speed) 
shapiro.test(data[data$probe=='2',]$max_speed)
shapiro.test(data[data$probe=='6',]$max_speed)
shapiro.test(data[data$probe=='3',]$max_speed) # data is not normally distributed
shapiro.test(data[data$probe=='7',]$max_speed) # data is not normally distributed


shapiro.test(data[data$probe=='8',]$length)
shapiro.test(data[data$probe=='4',]$length) 
shapiro.test(data[data$probe=='2',]$length)
shapiro.test(data[data$probe=='6',]$length)
shapiro.test(data[data$probe=='3',]$length) 
shapiro.test(data[data$probe=='7',]$length)


shapiro.test(data[data$probe=='8',]$distance)
shapiro.test(data[data$probe=='4',]$distance)
shapiro.test(data[data$probe=='2',]$distance)
shapiro.test(data[data$probe=='6',]$distance)
shapiro.test(data[data$probe=='3',]$distance) 
shapiro.test(data[data$probe=='7',]$distance)


shapiro.test(data[data$probe=='8',]$DC)
shapiro.test(data[data$probe=='4',]$DC)
shapiro.test(data[data$probe=='2',]$DC)
shapiro.test(data[data$probe=='6',]$DC)
shapiro.test(data[data$probe=='3',]$DC)
shapiro.test(data[data$probe=='7',]$DC)



shapiro.test(data[data$probe=='8',]$emax)
shapiro.test(data[data$probe=='4',]$emax)
shapiro.test(data[data$probe=='2',]$emax)
shapiro.test(data[data$probe=='6',]$emax)
shapiro.test(data[data$probe=='3',]$emax)
shapiro.test(data[data$probe=='7',]$emax)
...
data$cells[data$probe == 3] <- 'Jurkat control'

data$cells[data$probe == 7] <- 'Jurkat MbCD'
...
data$line[data$probe == 3] <- 'Jurkat'
data$line[data$probe == 7] <- 'Jurkat'
...
ggdensity(data[data$line=='Jurkat',], x = "mean_speed",
          add = "mean", rug = TRUE,
          color = "cells", fill = "cells",
          palette = "rainbow")


ggdensity(data[data$line=='Jurkat',], x = "max_speed",
          add = "mean", rug = TRUE,
          color = "cells", fill = "cells",
          palette = "rainbow")
...
ggdensity(data[data$line=='Jurkat',], x = "length",
          add = "mean", rug = TRUE,
          color = "cells", fill = "cells",
          palette = "rainbow")


ggdensity(data[data$line=='Jurkat',], x = "emax",
          add = "mean", rug = TRUE,
          color = "cells", fill = "cells",
          palette = "rainbow")
...
ggdensity(data[data$line=='Jurkat',], x = "distance",
          add = "mean", rug = TRUE,
          color = "cells", fill = "cells",
          palette = "rainbow")
...
ggdensity(data[data$line=='Jurkat',], x = "DC",
          add = "mean", rug = TRUE,
          color = "cells", fill = "cells",
          palette = "rainbow")
...
ggcorr(data[data$line=='HUVEC',], palette = "RdBu", label = TRUE)

ggcorr(data[data$line=='Jurkat',], palette = "RdBu", label = TRUE)
